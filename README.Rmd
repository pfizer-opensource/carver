...
Development of an open-source tool and package to enable generation of identified interactive plots for clinical review and direct inclusion in submission for regulatory agencies. The scope includes Shiny application for complete safety report generation from Analysis Model (ADaM) datasets.
